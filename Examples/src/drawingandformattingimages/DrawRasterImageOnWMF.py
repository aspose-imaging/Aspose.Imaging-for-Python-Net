...
# Example code:
print("Running example DrawRasterImageOnWMF")
# The path to the documents directory.
data_dir = os.path.join(get_data_root_dir(), "DrawingAndFormattingImages")
out_file = os.path.join(get_output_dir(), "asposenet_222_wmf_200.DrawImage.wmf")
...
with aspycore.as_of(Image.load(os.path.join(data_dir, "asposenet_220_src01.png")),
	...
	with aspycore.as_of(Image.load(os.path.join(data_dir, "asposenet_222_wmf_200.wmf")),
		                WmfImage) as canvas_image:
...
print("Finished example DrawRasterImageOnWMF")
