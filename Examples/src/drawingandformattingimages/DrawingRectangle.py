...
# Example code:
print("Running example DrawingRectangle")
# The path to the documents directory.
out_file = os.path.join(get_output_dir(), "SampleRectangle_out.bmp")
...
with BmpOptions() as save_options:
	...
	with Image.create(save_options, 100, 100) as image:
		...
		graphic.draw_rectangle(Pen(Color.red), Rectangle(30, 10, 40, 80))
		graphic.draw_rectangle(Pen(SolidBrush(Color.blue)), Rectangle(10, 30, 80, 40))
		image.save(out_file)

if 'SAVE_OUTPUT' not in os.environ:
	os.remove(out_file)
	
print("Finished example DrawingRectangle")
