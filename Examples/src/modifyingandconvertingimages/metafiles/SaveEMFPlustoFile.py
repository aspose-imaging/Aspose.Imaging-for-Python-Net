...
path = os.path.join(data_dir, "TestEmfPlusFigures.emf")
out_path = os.path.join(get_output_dir(), "TestEmfPlusFigures.emf.emf")
print("Running example SaveEMFPlustoFile")
...
print("Finished example SaveEMFPlustoFile")
