...
out_file = os.path.join(get_output_dir(), 'AdjustBrightnessDICOM_out.bmp')
print("Running example AdjustBrightnessDicom")
...
print("Finished example AdjustBrightnessDicom")
