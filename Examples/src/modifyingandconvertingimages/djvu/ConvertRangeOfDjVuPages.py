...
# Example code:
print("Running example ConvertRangeOfDjVuPages")

# The path to the documents directory.
data_dir = os.path.join(get_data_root_dir(), 'djvu')
out_file = os.path.join(data_dir, "ConvertRangeOfDjVuPages_out.tiff")
# Load a DjVu image
...
print("Finished example ConvertRangeOfDjVuPages")
